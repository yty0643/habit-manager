...
const VACHabitAddForm = ({ isDark, isCheck, isName, isDescription, isGoal, onClick, exit, onChange }: { isDark:boolean, isCheck:boolean, isName: boolean, isDescription: boolean, isGoal: boolean, onClick: IOnClick, exit: IOnClick, onChange: IOnChange }) => {
    ...
    return (
        <form className={styles.form}>
            ...
            <div className={styles.btns}>
                <button className={`${styles.exitBtn} ${isDark && styles.dark}`} onClick={exit}>exit</button>
